  ...
  render() {
    ...
    return (
      <Modal isOpen={open} contentLabel="Modal" style={styles}>
        ...
        <H1 mb={2}>Netlify static form submission. It's awesome.</H1>
        <Flex wrap justify="center" py={3}>
          <Box width={[1, 1, 1 / 2]} p={1}>
            <H4 mb={2}>Email</H4>
            <P mr={[0, 0, 2]}>
              Throw in soome client-side form validation 😈 and you are good to
              go. Use the Netlify UI to connect each form to{" "}
              <a href="https://ifttt.com/">IFTTT</a>,{" "}
              <a href="https://zapier.com/">Zapier</a>, etc.
            </P>
          </Box>
          <Box width={[1, 1, 1 / 2]} p={1}>
